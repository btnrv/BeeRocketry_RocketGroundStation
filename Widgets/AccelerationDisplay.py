...
class AccelerationDisplay(QWidget):
    def __init__(self, name="Default"):
        super().__init__()

        # Create sub-widget and set layout
        ...
        graph_layout.addWidget(self.line_canvas, 2)
        ...
        self.sum_label.setStyleSheet("color: white; font-size: 20px; font-weight: bold; font-family: EncodeSans;")
        ...
        self.label_layout.addWidget(self.sum_label)
    ...
    def plot_data(self):
        ...
        self.line_ax.plot(self.time_data, self.sum_data, color="white", lw=2, label='Sum')
    ...
    def update(self, x, y, z, sum_value):
        ...
        self.sum_label.setText(f"Sum: {self.sum_value:.2f}")
        ...
        self.sum_data.append(self.sum_value)
...
if __name__ == "__main__":
    ...
    widget = AccelerationDisplay("Acceleration Display Widget")
    widget.show()
    sys.exit(app.exec())
