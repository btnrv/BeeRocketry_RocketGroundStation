...
class DataTable(QWidget):
    ...
    def update_data(self, packet):
        ...
        self.labels["Irtifa"].setText(f"Irtifa: {packet.irtifa}")
        self.labels["GPS Irtifa"].setText(f"GPS Irtifa: {packet.gpsIrtifa}")
        self.labels["GPS Enlem"].setText(f"GPS Enlem: {packet.gpsEnlem}")
        self.labels["GPS Boylam"].setText(f"GPS Boylam: {packet.gpsBoylam}")
        self.labels["Gorev Yuku Irtifa"].setText(f"Gorev Yuku Irtifa: {packet.gorevYukuIrtifa}")
        self.labels["Gorev Yuku Enlem"].setText(f"Gorev Yuku Enlem: {packet.gorevYukuEnlem}")
        self.labels["Gorev Yuku Boylam"].setText(f"Gorev Yuku Boylam: {packet.gorevYukuBoylam}")
        self.labels["Jiroskop X"].setText(f"Jiroskop X: {packet.jiroskopX}")
        self.labels["Jiroskop Y"].setText(f"Jiroskop Y: {packet.jiroskopY}")
        self.labels["Jiroskop Z"].setText(f"Jiroskop Z: {packet.jiroskopZ}")
        self.labels["Ivme X"].setText(f"Ivme X: {packet.ivmeX}")
        self.labels["Ivme Y"].setText(f"Ivme Y: {packet.ivmeY}")
        self.labels["Ivme Z"].setText(f"Ivme Z: {packet.ivmeZ}")
        self.labels["Aci"].setText(f"Aci: {packet.aci}")
        self.labels["Yaw"].setText(f"Yaw: {packet.yaw}")
        self.labels["Roll"].setText(f"Roll: {packet.roll}")
        self.labels["Pitch"].setText(f"Pitch: {packet.pitch}")
        self.labels["Nem"].setText(f"Nem: {packet.nem}")
        self.labels["Sicaklik"].setText(f"Sicaklik: {packet.sicaklik}")
